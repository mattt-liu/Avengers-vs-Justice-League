...
screen_res=(1200,700)
####NEW#####
fireballLogo=image.load("Pictures/fireball.png")
lightningLogo=image.load("Pictures/lightning.png")
tornadoLogo=image.load("Pictures/tornado.png")
...
##cyborg=justice1File[0]
##flash=justice1File[1]
##lantern=justice1File[2]
##aqua=justice1File[3]
##woman=justice1File[4]
##batman=justice1File[5]
##superman=justice1File[6]
##
##print(avengers1File)
##print(hawk)
##print(spider)
...
def special1():
    ...
    while running:
        ...
        if attack1:
            ...
            for u in range(1):
                if l-u*250>=150:
                    screen.blit(tornado[frame1] , (l-u*250,150)) 
                    screen.blit(tornado[frame1] , (l-u*250,230))
                    screen.blit(tornado[frame1] , (l-u*250,310))
                    screen.blit(tornado[frame1] , (l-u*250,390))
                    screen.blit(tornado[frame1] , (l-u*250,470))
                    screen.blit(tornado[frame1] , (l-u*250,550))
            frame1 += 1
            display.flip()
            if frame1 == 10:
                frame1 = 0
...
#############################################
    ...
    mb   =mouse.get_pressed()
        ...
        screen.blit(screenshot , (0,0))
    #if hawk.collidepoint(mx,my) or spider.collidepoint(mx,my) or hulk.collidepoint(mx,my) or silver.collidepoint(mx,my) or captain.collidepoint(mx,my) or iron.collidepoint(mx,my) or thor.collidepoint(mx,my):
        #if mb[0]==1:
            #upgradeAvengers1()
    #if cyborg.collidepoint(mx,my) or flash.collidepoint(mx,my) or lantern.collidepoint(mx,my) or aqua.collidepoint(mx,my) or  woman.collidepoint(mx,my) or batman.collidepoint(mx,my) or superman.collidepoint(mx,my):
        #if mb[0]==1:
            #upgradeJustice1()
    #pause_menu()
